#pragma checksum "C:\Users\iainr\Documents\repos\AlgorithmTester\Views\Home\Instructions.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "329de34466af3419a61b690d8f9d79786e417389"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"329de34466af3419a61b690d8f9d79786e417389", @"/Views/Home/Instructions.cshtml")]
...
<div id=instructions>
    <h5>Code Input</h5>
    <p>
        C# is to be entered into the indicated text box. The function to be tested must be a static method called ""Algorithm"".
        The method must be held in a class called ""Solution"". The default code provided shows correct class and method headers.
    ...
    <p>  
        ...
        defined within the algorithm. Collections may be used, but not as the Algorithm method's input arguments or return type.
        Additionally, the appropriate using directive must be defined.
    </p>
    <h5>Testing Data</h5>
    <p>
        Data for accuracy testing can be provided in the label");
            WriteLiteral(@"led text boxes. If multiple inputs are required, these should be comma separated.
    ...
    <p>
        ...
        this time is exceeded using a specific set of input arguments, this data will be labelled to indicate th");
            WriteLiteral(@"at the program timed out.
    </p>
    ...
    <p>
        ...
        is required, then no data is required to be entered by the user as the speed-testing data is automatically genarated. The program may take
        significant time to perform the calculation if the provided algorithm is computationally expensive. However, it will never take longer than the
        defined maximum execution time.
    </p>
    <p>
        If there are any errors in the user provided code, these will be displayed beneath the code input text box. For example, mistakes with the class
    ...
    <p>
        If accuracy-testing data is");
            WriteLiteral(@" provided, the accuracy value will be displayed showing the accuracy percentage. Additionally, each set of data
